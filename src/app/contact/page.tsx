  ...
  return (
    <>
          ...
          <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2">
              <ScrollReveal direction="left">
                ...
                <h2 className="font-[family-name:var(--font-heading)] mb-4 text-3xl font-bold text-dark">
                  Let&apos;s Talk
                </h2>
            ...
            <div className="lg:col-span-3">
              <ScrollReveal direction="right">
                <div className="rounded-xl bg-light p-8 md:p-10">
      ...
      <section className="relative h-[400px] bg-gray-200">
        <div className="absolute inset-x-0 top-0 z-10 h-8 bg-gradient-to-b from-white to-transparent" />
        <iframe
